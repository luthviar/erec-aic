				...
				<div class="box box-default box-solid">
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							<a href="javascript:void(0);" OnClick="link_to('apply');" class="btn btn-sm btn-social">
					...
					<div class="box-body table-responsive">
						...
						<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>apply/update-data">
							<input type="hidden" name="id" value="<?php echo simple_encrypt($row->request_id); ?>" />
							<input type="hidden" name="count" value="<?php echo $row->request_count; ?>" />
																				...
																				<table class="table table-hover">
																					...
																					<tr>
																						<td align="center">
																							<div class="btn-group">
																								<?php if($rows->join == "") { ?>
																								<input type="checkbox" name="check[]" value="<?php echo simple_encrypt($rows->id); ?>" />
																								<?php } else { ?>
