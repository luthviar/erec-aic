						...
						<table id="example1" class="table table-bordered table-hover table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo ((strlen($row->request_description) > 75)?strip_tags(substr($row->request_description, 0, 75) ." ..."):strip_tags($row->request_description)); ?></td>
									<td align="center"><?php echo get_approved($row->request_status); ?></td>
									<td align="center">
										<div class="btn-group">
											<a href="javascript:void(0);" onClick="edit_data('approval/request', '<?php echo simple_encrypt($row->request_id); ?>');" class="btn btn-default btn-sm"><i class="fa fa-pencil"></i></a>
										</div>
									</td>
								</tr>
								<?php endforeach; ?>
