            ...
            <div class="col-xs-12">
				...
				<div class="box box-default box-solid">
					...
					<div class="box-body table-responsive">
						...
						<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>request/insert-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<div class="input-group">
											...
											<input type="text" class="form-control pull-right" id="datemask" name="date_start" value="<?php echo convert_to_dmy(get_ymd()); ?>" autocomplete="off" required />
										</div><!-- /.input group -->
									</div>
								</div>
								<div class="form-group">
