	  ...
	  <!-- Main content -->
		...
		<section class="invoice">
			...
			<div class="row">
				<div class="col-xs-12">
					<h2 class="page-header">
						<i class="fa fa-sign-in"></i> REQUEST.
						<small class="pull-right">status : <b><?php echo get_approved($row->request_status); ?></b></small>
					</h2>
				</div>
				<!-- /.col -->
			</div>
				...
				<div class="col-sm-2 invoice-col">
					<address>
						<table border="0" width="100%">
							...
							<tr><td height="20" valign="top"><strong>Placement Date</strong></td></tr>
						</table>
					</address>
				</div>
				<!-- /.col -->
				<div class="col-sm-10 invoice-col">
					<address>
						<table border="0" width="100%">
							...
							<tr><td height="20" valign="top"><?php echo convert_to_dmy($row->request_overdue); ?></td></tr>
						</table>	
					</address>
				</div>
				<!-- /.col -->
			...
			<div class="row">
				<!-- accepted payments column -->
				<div class="col-xs-3">
					<p><?php echo (($row->request_date == "")?"-":convert_to_dmy($row->request_date)); ?></p>
				...
				<!-- /.col -->
				<div class="col-xs-3">
					<p><?php echo (($row->approval1_date == "")?"-":convert_to_dmy($row->approval1_date)); ?></p>
					<p class="lead">Approved 1 By</p>
					<br /><br />
					<p>..............................</p>
					<p class="lead"><?php echo (($row->approval1_id == "")?"-":strip_tags($this->m_user->get_name_by_id($row->approval1_id))); ?></p>
				</div>
				<!-- /.col -->
				<div class="col-xs-3">
					<p><?php echo (($row->approval2_date == "")?"-":convert_to_dmy($row->approval2_date)); ?></p>
					<p class="lead">Approved 2 By</p>
					<br /><br />
					<p>..............................</p>
					<p class="lead"><?php echo (($row->approval2_id == "")?"-":strip_tags($this->m_user->get_name_by_id($row->approval2_id))); ?></p>
				</div>
				<!-- /.col -->
				<div class="col-xs-3">
					<p><?php echo (($row->recruitment_date == "")?"-":convert_to_dmy($row->recruitment_date)); ?></p>
					<p class="lead">Recruitment By</p>
					<br /><br />
					<p>..............................</p>
					<p class="lead"><?php echo (($row->recruitment_id == "")?"-":strip_tags($this->m_user->get_name_by_id($row->recruitment_id))); ?></p>
				</div>
				<!-- /.col -->
			</div>
			<!-- /.row -->
