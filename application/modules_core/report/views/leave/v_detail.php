            ...
            <div class="col-xs-12">
				...
				<div class="box box-default box-solid">
					<div class="box-header with-border">
						<h3 class="box-title">Detail Leave</h3>
						<div class="box-tools pull-right">
							<a href="javascript:void(0);" OnClick="link_to('report/leave');" class="btn btn-sm btn-social">
										...
										<form class="form-horizontal" method="post">
											...
											<div class="box-body">
												<div class="form-group">
													...
													<div class="col-sm-3">
														<label>
															...
															&nbsp;&nbsp; <?php echo get_approved($row->leave_status); ?>
														</label>
													</div>
												...
												<div class="form-group">
													<label class="col-sm-2 control-label"></label>
													<div class="col-sm-9">
														<a href="javascript:void(0);" OnClick="link_preview('report/leave', '<?php echo simple_encrypt($row->leave_id); ?>');" class="btn btn-primary pull-right" style="margin-right: 5px;">
									...
									<div class="box-body table-responsive">
										<form class="form-horizontal" method="post" action="">
												...
												<div class="col-sm-3">
													<div class="input-group">
														...
														<div class="bootstrap-timepicker">
															<input type="text" class="form-control pull-right" value="<?php echo (($row->leave_date == "")?"-":convert_to_dmy($row->leave_date)) .' '. (($row->leave_time == "")?"-":convert_to_his($row->leave_time)); ?> " readonly />
														</div>
													</div><!-- /.input group -->
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<textarea class="form-control" rows="2" style="resize: none;" readonly><?php echo (($row->leave_description == "")?"":strip_tags($row->leave_description)); ?></textarea>
												</div>
											</div>
											<div class="form-group">
